  ...
  const resources = [
    {
      ...
      title: 'User Guides',
      description:
        "Step-by-step guides to help you get the most out of Kisan AI's features.",
      content: [
        {
          title: 'Getting Started with Kisan AI',
          link: '/guides/getting-started',
        },
        { title: 'Setting Up Your Farm Profile', link: '/guides/farm-profile' },
        { title: 'Using AI Crop Analysis', link: '/guides/crop-analysis' },
        {
          title: 'Managing Resources Efficiently',
          link: '/guides/resource-management',
        },
        {
          title: 'Understanding Analytics Dashboard',
          link: '/guides/analytics-dashboard',
        },
